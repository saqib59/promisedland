        ...
        <div class="search">
            <div class="container">
                <div class="search_form">
                    <div class="search_form__title">
                        <h2>Die Nr. 1 bei Zwangsversteigerungen</h2>
                    </div>
                    <div class="search_form__area">
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-10 col-sm-12 col-12 mx-auto">
                                <div class="search_form__area-body">
                                    <form action="<?= LINK ?>/search/" method="GET" autocomplete="off">
                                        ...
                                        <div class="search_form_fields">
                                            <div class="row">
                                                <div class="col">
                                                    <label>Adresse</label>
                                                    <input id="searchInput" class="form-control" type="text" name="address" placeholder="Wo: Stadt, PLZ, Straße">
                                                </div>
                                                <div class="col">
    ...
    <section id="listing">
        <div class="container">
            <div class="top-listing">
                <div class="row row-cols-xl-3 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 show_grid">
