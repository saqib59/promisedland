...
if (role('manager')) {
    $listings = $db->query('SELECT * FROM `listing` WHERE completed = 2 AND admin = ?;', $_SESSION['admin'])->fetchAll();
} else {
    $listings = $db->query('SELECT * FROM `listing` WHERE completed = 2;')->fetchAll();
}
...
<head>
    ...
    <title>Archived Listings - PromisedLand</title>
</head>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($listings as $item) {
                                            ...
                                            //$actions .= '<a href="' . ADMIN . '/complete_listings.php?listing_id=' . $item['id'] . '&action=pen" class="btn btn-danger" title="Delete Listing" onclick="return confirm(\'Are you sure to delete this listing?\');"><i class="fa fa-trash-alt"></i></a>';
